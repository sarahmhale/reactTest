...
class Home extends Component {
  constructor(props){
    ...
    render() {
        ...
        return <View>
            <View>
                <Button title="Fetch Ledamöter"onPress={() => this.searchedLedamoter()}>
                </Button>
            </View>
            <ScrollView>
              {this.ledamoter().map((ledamoter)=>{
                ...
                return(
                <View key={ledamoter.hangar_id} style={Style.container}><Image source={{
                      uri: ledamoter.bild_url_80}} style={Style.photo}/>
